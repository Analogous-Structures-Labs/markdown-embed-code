...
@pytest.mark.parametrize(
    "extra,expected",
    [
        ("tests/src/sample.py[4:5]", {"file_path":"tests/src/sample.py", "start_at": 4, "end_at": 5}),
        ("tests/src/sample.py [4:5]", {"file_path":"tests/src/sample.py", "start_at": 4, "end_at": 5}),
        ("tests/src/sample.py      [4:5]", {"file_path":"tests/src/sample.py", "start_at": 4, "end_at": 5}),
        ("tests/src/sample.py [ 4:5 ]", {"file_path":"tests/src/sample.py", "start_at": 4, "end_at": 5}),
        ("tests/src/sample.py [ 4 : 5 ]", {"file_path":"tests/src/sample.py", "start_at": 4, "end_at": 5}),
        ("tests/src/sample.py [4]", {"file_path":"tests/src/sample.py", "start_at": 4, "end_at": 4}),
        ("tests/src/sample.py [4:]", {"file_path":"tests/src/sample.py", "start_at": 4, "end_at": None}),
        ("tests/src/sample.py [:5]", {"file_path":"tests/src/sample.py", "start_at": 1, "end_at": 5}),
        ("tests/src/sample.py [0:]", {"file_path":"tests/src/sample.py", "start_at": 1, "end_at": None}),
        ("tests/src/sample.py [:]", {"file_path":"tests/src/sample.py", "start_at": 1, "end_at": None}),
        ("tests/src/sample.py []", {"file_path":"tests/src/sample.py", "start_at": 1, "end_at": None}),
        ("tests/src/sample.py [", {"file_path":"tests/src/sample.py [", "start_at": 1, "end_at": None}),
    ],
)
def test_embed_parsing(extra, expected):
    assert Embed.parse_from_extra(extra).__dict__ == expected, f"{extra} did not parse as expected"
